...
LicenseManager::LicenseManager(const QByteArray& publicKeyPEM, const QByteArray& saltMD5, const QByteArray& softwareCodeMD5,
                               const QByteArray& customerCodeMD5, const QByteArray& activationCodeRaw)
...
{
    QByteArray sn = QCryptographicHash::hash(UniqueMachineID::getMachineID(m_saltMD5), QCryptographicHash::Md5);
